...
public class AdminBulkyRequestController {
    ...
    public String routeRequestPage( Model model,
        ...
        model.addAttribute("dto", new AdminBulkyRequestDto() );
    ...
    public String processRequest(   @Valid AdminBulkyRequestDto adminBulkyRequestDto, BindingResult bindingResult,
                                    @AuthenticationPrincipal AccessedUser user  ) throws ParseException {
        ...
        Employee employee = employeeService.getEmployeeByAccessedUser(user);
        bulkyRequestService.createRequest(adminBulkyRequestDto, employee);
        return "forward:/admin/bulky/request/result";
    }

    @PostMapping(value = "/result")
    public String routeResultPage() {
